#!/usr/bin/env python3
# -*- coding: utf-8 -*- 
# @Time : 1/21/2019 1:04 PM 
# @Author : Xiang Chen (Richard)
# @File : trajectory_FFT.py 
# @Software: PyCharm
import cv2
import numpy as np
import glob
...
trajectory_image = glob.glob(
    r'C:\Users\LPT-ucesxc0\AIS-Data\Frequency_domain_processing_trajectory_image\AIS_trajectory_image_clip_labels\*.jpg')
for image in trajectory_image:
    ...
    plt.axis('off')
    plt.savefig(
        r'C:\Users\LPT-ucesxc0\AIS-Data\Frequency_domain_processing_trajectory_image\High_filter_image\%s.jpg' % (
            image_name1))
    # plt.show()
    ...
    plt.axis('off')
    plt.savefig(
        r'C:\Users\LPT-ucesxc0\AIS-Data\Frequency_domain_processing_trajectory_image\Low_filter_image\%s.jpg' % (
            image_name1))
    ...
    plt.axis('off')
    plt.savefig(
        r'C:\Users\LPT-ucesxc0\AIS-Data\Frequency_domain_processing_trajectory_image\Band_filter_image\%s.jpg' % (
            image_name1))
